...
var URLFILE_DEFAULT = "http://frozen-plains-7617.herokuapp.com";
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <remote_html_file>', 'Path to remote index.html', clone(assertURLExists), URLFILE_DEFAULT)
        .parse(process.argv);
    if (program.file) {
